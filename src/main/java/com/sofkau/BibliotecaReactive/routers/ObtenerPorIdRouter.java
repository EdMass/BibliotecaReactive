...
import com.sofkau.BibliotecaReactive.usecase.UseCaseObtenerPorId;
    ...
    public RouterFunction<ServerResponse> obtenerPorId(UseCaseObtenerPorId useCaseObtenerPorId) {
        return route(
                ...
                request -> ServerResponse.ok()
                        ...
                        .body(BodyInserters.fromPublisher(useCaseObtenerPorId.get(request.pathVariable("id")), BibliotecaDTO.class))
        );
    }
}
